...
| `dashboard.html` | 上記すべてから `../skills/volante/scripts/dashboard-generate.py` が生成する自己完結 HTML (観察・振り返り用、read-only) |
| `about.html` | harness 内部処理 (巡回サイクル・データフロー・判断木概要) の説明ページ。手書き静的ファイルなので `../CHANGELOG.md` の「リリースチェック項目」で陳腐化を確認する (issue #34) |
